...
public interface DataBusDao {
    PagingObject getRecords(ResourceConfiguration resourceConfiguration, Map<String, String> filters, Integer pageNum, Integer pageSize, String sortBy, Boolean reverse);
}
