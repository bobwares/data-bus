...
public class TableBuilder {
    ...
    public TableBuilder setPageMargin(float pageMargin) {
        table.setPageMargin(pageMargin);
        return this;
    }
    ...
    public TableBuilder setOrientation(Orientation orientation) {
    ...
    public TableBuilder setLabelFont(PDFont labelFont) {
        table.setLabelFont(labelFont);
        return this;
    }
