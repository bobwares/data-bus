...
@Service
public class DataBusExternalRequestGateway implements DataBusRequestGateway {
    ...
    public ResponseObject processRequest(MultiValueMap<String, Object> parameters, String resourceKey) throws Exception {
        RequestObject requestObject = requestObjectBuilder.build(parameters, resourceKey, RequestSource.EXTERNAL);
